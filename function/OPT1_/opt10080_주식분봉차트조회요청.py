#opt10080 : 주식분봉차트조회요청
#부가설명 : 1, 3, 5, 10, 15, 30, 60분 봉의 데이터를 각각 얻을 수 있음.
...
class Program(QMainWindow):
    ...
    def requestTrData(self, c):
            ...
            self.kiwoom.dynamicCall("SetInputValue(QString, QString)", "틱범위", "3")  # 1: 1분, 3: 3분, 5: 5분, 15: 15분, 30: 30분, 45: 45분, 60: 60분
            ...
            self.kiwoom.dynamicCall("CommRqData(QString, QString, int, QString)", "opt10080_req", "opt10080", c, "0766") # 사용사요청명칭 / 요청함수 / 초기조회:0, 연속조회:2 / 화면번호
